...
namespace hlcWeb.Controllers.Api
{
    public class BaseController : ApiController
    {
        ...
        protected Geocode GeocodeAddress(string address)
        {
            ...
            var geo = Newtonsoft.Json.JsonConvert.DeserializeObject<Geocode>(response.Content);

            var lat = geo.results[0].locations[0].latLng.lat;
            var lng = geo.results[0].locations[0].latLng.lng;
